...
/**
 * <br/>
 * A <tt>custom generator</tt> that behaves as follows: If id is null (or zero to workaround a
 * hibernate bug), behave as if generator was set to AUTO (i.e. get the autoincrement value from the
 * database. Otherwise use the provided ID.
 *
...
public class IDPresentAwareGenerator extends IdentityGenerator {
    ...
    public Serializable generate(SessionImplementor session, Object obj) {
        ...
        if (result == null || (result.toString().equals("0"))) {
            result = IdentifierGeneratorHelper.POST_INSERT_INDICATOR;
        }
